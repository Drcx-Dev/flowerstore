...
import { products } from "../products"; // Импортируем массив товаров
    ...
    <section>
      <main className="bg-gray-100 min-h-screen">
        <div className="justify-self-center mt-4">
          <h1 className="text-gray-700">Главная/Подарки/Все Подарки</h1>
          <h1 className="font-bold text-3xl mt-3 pl-5">Подарки</h1>
        </div>
