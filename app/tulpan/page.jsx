...
import { productsrose } from "../productsrose";
    ...
    <section>
      <main className="bg-gray-100 min-h-screen">
        <div className="justify-self-center mt-4">
          <h1 className="text-gray-700">Главная/Цветы/Тюльпаны</h1>
          <h1 className="font-bold text-3xl mt-3 pl-5">Все тюльпаны</h1>
        </div>

        {/* Карточки товаров */}
        <div className="flex flex-wrap gap-8 mt-8 justify-center ">
          {productstulpan.map((product) => (
            <div
              key={product.id}
            ...
            {cart.length > 0 && (
              <>
                <div className="mt-4 text-xl font-semibold">
                  <p>Общая стоимость: {totalPrice} грн.</p>
                </div>
              </>
            )}
            <button
